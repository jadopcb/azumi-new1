...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/jadopcb/6TO4-GRE-IPIP-SIT/main/managed4.sh)"
```
...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/jadopcb/6TO4-GRE-IPIP-SIT/main/managed3.sh)"
```
----------------
- نسخه های پایین ممکن است برای همه قابل اجرا نباشد و برای سرور های با رم بالا است
```
apt install python3 -y && sudo apt install python3-pip &&  pip install colorama && pip install netifaces && apt install curl -y && python3 <(curl -Ls https://raw.githubusercontent.com/jadopcb/6TO4-GRE-IPIP-SIT/main/ipipv2.py --ipv4)
```
...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/jadopcb/6TO4-GRE-IPIP-SIT/main/managed2.sh)"
```
---------------------------------------------
